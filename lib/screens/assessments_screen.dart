...
class _AssessmentsScreenState extends State<AssessmentsScreen> {
  ...
  Future<bool> _canAccessLevel(int level) async {
    ...
    print(
        'Checking access for Level $level: Previous level score = $score'); // Debug log
    return score >= 8;
  }
  ...
  void _answerQuestion(String selected) async {
    ...
    if (_currentQuestion < _questions[_currentLevel]!.length - 1) {
      ...
      print('Saved score for Level $_currentLevel: $_score'); // Debug log
      setState(() {
        _quizCompleted = true;
        _quizStarted = false;
        _feedback = null;
        ...
        children: [
          ...
          FutureBuilder<List<int>>(
            ...
            builder: (context, snapshot) {
              ...
              print('Loaded scores: $scores'); // Debug log
              return Column(
                children: [
